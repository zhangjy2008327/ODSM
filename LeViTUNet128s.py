...
def Build_LeViT_UNet_128s(num_classes=1, distillation=True,
              pretrained=False, fuse=False):
    return model_factory_v3_NM(**specification['LeViT_128S'], num_classes=num_classes,
...
class LeViT_UNet_128s(torch.nn.Module):
    ...
    def __init__(self, img_size=224, ## aping: should change
        ...
        self.decoderBlock_1 = DecoderBlock(n + (128+256+384), 512) #->att+cnn:128+768=896  '128_256_384'
...
#         net = Build_LeViT_UNet_128s(num_classes=9, pretrained=True)
#         net.eval()
